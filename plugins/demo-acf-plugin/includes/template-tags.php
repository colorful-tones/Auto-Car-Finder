...
function demo_acf_display_notification_bar() {
	...
	<div class="demo-acf-notification-bar" style="margin-top:0;padding-top:15px;padding-right:30px;padding-bottom:15px;padding-left:30px;background-color:var(--wp--preset--color--luminous-vivid-amber);color:black;">
